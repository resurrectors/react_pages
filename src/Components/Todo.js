...
function Todo() {
    ...
    const sortedTodos = filteredTodos.sort((a, b) => {
        ...
        // Add other sorting mechanisms here as needed
    });
            ...
            <div className="todo-container">
                ...
                <div>
                    ...
                    <table className="table">
                        <thead>
                            <tr>
                                ...
                                <th style={{ "width": "75%" }} scope="col">
                                    Details
                                    <svg className="m-3" onClick={() => setSortType(sortType === "name" ? 'createdAt' : 'name')} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-down" viewBox="0 0 16 16">
                        ...
                        <tbody>
                            {sortedTodos.filter(todo => todo.text.toLowerCase().includes(inputValue.toLowerCase())).map(todo => (
                                <tr key={todo.id} className={todo.completed ? 'table-success' : ''}>
                                    ...
                                    <td>
                                        <div className="row align-items-center justify-content-center" style={{ "margin": "10px" }}>
                                            <div className="col-6 align-items-center">
                                                <button type="button" class="btn" data-bs-toggle="modal" onClick={() => setEditValue(todo.text)} data-bs-target={`#exampleModal-${todo.id}`}>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="button" class="btn btn-primary" data-bs-dismiss="modal" onClick={() => saveEditChange(todo.id)}>Save changes</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
